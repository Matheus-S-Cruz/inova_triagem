    ...
    <ScreenWrap>
      ...
      <Content>
        ...
        >
          ...
          <Field
            label="Código da unidade (CNES)"
            placeholder="Ex: 0012345"
            hint="Código Nacional de Estabelecimentos de Saúde"
          />
          <Field
            label="Usuário"
        ...
        >
          Acesso autorizado somente a servidores cadastrados.
          <br />
  ...
  return (
    <ScreenWrap>
      ...
      <Content>
        ...
        >
          <div style={{ fontSize: 13, fontWeight: 700, color: "#0F2A4A" }}>
            UPA Santo André
          </div>
          <div
            style={{
          ...
          >
            CNES 0012345 · Última atualização: 5 min atrás
          </div>
        </div>
        ...
        >
          ...
          <span style={{ fontSize: 12, color: "#4E6A80" }}>
            {OCC_LABELS[occ]}
          </span>
        </div>
          ...
          {(["low", "medium", "high"] as OccLevel[]).map((level) => (
            <button
              ...
              style={{
                ...
                border: "2px solid",
                borderColor:
                  occ === level ? OCC_SLIDER_COLORS[level] : "#D7E3EC",

                borderRadius: 8,
                backgroundColor:
                  occ === level ? `${OCC_SLIDER_COLORS[level]}15` : "#fff",
            ...
            >
              <div
                style={{
                  ...
                  backgroundColor: OCC_SLIDER_COLORS[occ],
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          <Btn
            label="Salvar e publicar status"
            onClick={handleSave}
            variant="primary"
          />
          <Btn
            label="Ver painel administrativo"
            onClick={() => navigate("admin")}
            variant="secondary"
          />
        </div>
  ...
  return (
    <ScreenWrap>
      ...
      <Content>
        ...
        >
          <div>
            <div style={{ fontSize: 11, fontWeight: 700, color: "#155E8A" }}>
              UPA Santo André
            </div>
            <div
              style={{
        ...
        >
          {[
            ...
            >
              ...
              <div style={{ fontSize: 10, fontWeight: 700, color: "#4E6A80" }}>
                {label}
              </div>
              <div
                style={{
            ...
            <div key={level} style={{ marginBottom: 8 }}>
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                  ...
                  />
                  <span style={{ fontSize: 11, color: "#155E8A" }}>
                    {level}
                  </span>
                </div>
                <span
        ...
        <div style={{ marginBottom: 16 }}>
          {TOP_SYMPTOMS.map(({ symptom, count }) => (
            ...
            >
              <span style={{ fontSize: 12, color: "#155E8A", minWidth: 110 }}>
                {symptom}
              </span>
              <div
                style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <div
                  style={{
                    ...
                    height: 8,
                    borderRadius: "50%",
                    backgroundColor: REGION_OCC_COLORS[demand],
                  }}
                />
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                ...
                <span
                  style={{
                    fontSize: 9,
                    fontWeight: 700,
                    color: REGION_OCC_COLORS[demand],

                    border: `1px solid ${REGION_OCC_COLORS[demand]}`,
                    borderRadius: 3,
                    padding: "0 4px",
          ...
          {[
            {
              time: "08:47",
              type: "high",
              msg: "3 casos de falta de ar nas últimas 2h — zona Sul",
            },
            ...
            {
              time: "06:55",
              msg: "Pico de 12 triagens simultâneas registrado",
            },
          ].map(({ time, type, msg }, i) => (
            <div
              key={i}
            ...
            >
              ...
              {type === "high" && (
                <span style={{ color: "#dc2626", fontSize: 12, flexShrink: 0 }}>
                  ⚠
                </span>
              )}
              <span style={{ fontSize: 11, color: "#3A5468", lineHeight: 1.4 }}>
                {msg}
              </span>
            </div>
          ))}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          />
          <Btn
            label="Atualizar lotação da unidade"
            onClick={() => navigate("occupancy")}
            variant="ghost"
          />
          <Btn
            label="Sair"
            onClick={() => navigate("teamlogin")}
            variant="ghost"
          />
        </div>
